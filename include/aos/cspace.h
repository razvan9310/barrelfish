...
#define TASKCN_SLOT_NSEP        (TASKCN_SLOTS_USER+3)   ///< Endpoint cap to the Nameserver.
#define TASKCN_SLOT_NETEP       (TASKCN_SLOTS_USER+4)   ///< Endpoint cap to the networking driver.
